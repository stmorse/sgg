...
parser.add_argument('--subfolder', type=str, default='mini',
...
#     load_data(args.batch_size, subfolder=args.subfolder, suffix=args.suffix)
train_loader, valid_loader, test_loader = \
    load_data2(args.batch_size, subfolder=args.subfolder, suffix=args.suffix)
...
def train(epoch, best_val_loss):
    ...
    encoder.train()
    decoder.train()
    # scheduler.step()  #<-- updated (moved to after optimizer.step)
    for batch_idx, (data, relations) in enumerate(train_loader):
        ...
        # data is [batch, atoms, time, dims] 
        # relations is [batch, atoms*atoms-1]  (directed graph edges)
        ...
        # edges is [batch, edges (n*(n-1)), types]
